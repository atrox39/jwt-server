...
hoistedDependencies:
  ...
  /cookie/0.5.0:
    cookie: private
  /create-jest/29.7.0(@types/node@20.8.4)(ts-node@10.9.1):
    create-jest: private
  ...
  /jest-circus/29.7.0:
    jest-circus: private
  /jest-cli/29.7.0(@types/node@20.8.4)(ts-node@10.9.1):
    jest-cli: private
...
pendingBuilds: []
prunedAt: Wed, 11 Oct 2023 07:00:30 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped: []
storeDir: /Users/atrox39/Library/pnpm/store/v3
